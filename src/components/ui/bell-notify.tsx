...
// bell-notify.tsx
// Cloche « notification » animée (glow + rayons) avec bouton CTA.
// Adapté pour ce projet : `<style jsx global>` (Next.js/styled-jsx, absent ici)
// → `<style>` injecté classique (CSS global, sélecteurs préfixés `.bell-*`).
...
.mid-ring {
  ...
  box-shadow: inset -0.3em 1.3em 0.4em -1em #fff5, -0.2em -1.2em 0.4em -0.4em #505050,
...
.mid-ring::after { right: -2%; }
.mid-ring::before { left: -2%; }
.bell-buff-t {
  background: #fff2;
  width: 72%;
  height: 12%;
...
.off .bell-btm2 { filter: brightness(0.02); }
.bell-ring-container {
  width: 74%;
  height: 24%;
...
.bell-ring {
  ...
  box-shadow: 0 0.8em 1em -0.3em #f8e1d0, inset 0 -6em 4em -4em #e3b695,
    inset 0 1em 3em 1em #fff4, inset 0 2em 3em 1em #fff, inset 0 100em 0 100em #2c2c2c;
}
.off .bell-ring {
  background: #000;
  box-shadow: 0 0.8em 1em -0.3em #0000, inset 0 -6em 4em -4em #e3b69500,
    inset 0 1em 3em 1em #fff0, inset 0 -2em 3em 1em #fff2, inset 0 100em 0 100em #000;
}
.bell-rays {
...
.bell-cta {
  ...
  box-shadow: inset 0 0.04em 0.06em 0 #fff, inset 0 1em 1em 0 #fff5, inset 0 0.2em 0.2em 0 #e3b695;
  animation: lumenbtn 5s ease-in-out infinite;
  border: none;
  white-space: nowrap;
}
.bell-cta:hover,
.bell-cta:focus-visible {
  color: #fff;
...
@keyframes lumen {
  0% { translate: calc(-0.8em * var(--degofrot)); }
  50% { translate: calc(0.8em * var(--degofrot)); }
  100% { translate: calc(-0.8em * var(--degofrot)); }
}
  ...
  const rootStyle = useMemo(
    () =>
      ({
        ...
        '--_size': `${size}px`,
        '--base-clr': baseColor,
        '--degofrot': String(rotationAmplitude),
  ...
  return (
    <div className={`bell-root ${className}`} style={rootStyle}>
      ...
      {showButton && (
        <button
          type="button"
          className={`bell-cta ${onState ? '' : 'hidden-button'}`}
